...
<div class="contents">![Stefano Cudini](stefano-cudini.png)</div>
...
<div class="contents">[Github.com](http://github.com/stefanocudini)
 [OpenStreetMap.org](http://www.openstreetmap.org/user/StefanoCudini)
 [Stackoverflow.com](http://stackoverflow.com/users/526444/stefanocudini)
</div>
...
*   Linguaggi: **PHP**, **Javascript**(client e server), Python, Bash scripting, C, Java
...
*   Daemons: **Apache**, Lighttpd, **Nginx**, Proftpd, Postfix, Dovecot, Fail2Ban
*   Sistemi Operativi: Ottime conoscenze di **Debian** GNU/Linux **Server**, Ubuntu Desktop, Windows XP
*   Sistemi di versioning: **Git**, Mercurial
*   Software particolari: **Qgis**, **Josm**, AutoCAD, [**CorelDraw**](http://easyblog.it/corso-coreldraw/), Inkscape, Gimp, VirtualBox
*   Cms e piattaforme web: **Wordpress**, Drupal, OsCommerce
*   Tools di sviluppo: Sublime Text, Nano, Gedit, **GruntJS**, NPM, Bower, Firebug, Chrome console
...
*   ### [Tracks Optimizer online](http://localhost/maps/gpx-simplify-optimizer/)
    ...
    Web app per **ottimizzare tracce** GPX/KML/GeoJSON online, con **algoritmo RDP**.
...
*   ### [Leaflet Control Search](http://labs.easyblog.it/maps/leaflet-search/)
    ...
    Popolare **plugin Leaflet** per la ricerca di elementi all'interno di un layer e tramite **Jsonp/Ajax**.
*   ### [Leaflet Panel Layers](http://labs.easyblog.it/maps/leaflet-panel-layers/)
...
<div class="title">Lavoro o posizione ricoperti</div>

<div class="contents">

*   Amministratore di sistema, programmatore Javascript, Grafico per la web app:
     [www.openmove.org](http://www.openmove.org/)
...
*   Progettazione e implementazione del sistema di acquisizione dati (daemon **NodeJS**):
     [GPS Data Server](http://labs.easyblog.it/maps/gpsdata_server/#architecture)
*   Implementazione dell'interfaccia di back-end per il **monitoring real-time** del **GPS Data Server**:
     [Monitoring](http://labs.easyblog.it/maps/gpsdata_server/#backend)
*   Riprogettazione del layout e integrazione con **jQuery UI**:
     [Front-end](http://labs.easyblog.it/maps/gpsdata_server/#frontend)
...
<div class="contents">GeoSolutions s.a.s.
...
<div class="title">Posizione ricoperta</div>
...
<div class="contents">Anno 2007</div>
...
<div id="cons">AI senti della legge 196/03 e successive modifiche autorizzo il trattamento dei miei dati personali contenuti in questo curriculum</div>

<div id="valid">[[Valid XHTML]](http://validator.w3.org/check?uri=referer) • [[Valid CSS]](http://jigsaw.w3.org/css-validator/check/referer)</div>
